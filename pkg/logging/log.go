...
func Setup() {
	logConf := dlog.LogConfig{
		Level: setting.AppSetting.Level,
		FW: dlog.ConfFileWriter{
			On:              setting.AppSetting.FileWriterOn,
			LogPath:         setting.AppSetting.Path,
			RotateLogPath:   setting.AppSetting.RotateLogPath,
			WfLogPath:       setting.AppSetting.WfLogPath,
			RotateWfLogPath: setting.AppSetting.RotateWfLogPath,
		},
		CW: dlog.ConfConsoleWriter{
			On:    setting.AppSetting.ConsoleWriterOn,
			Color: setting.AppSetting.ConsoleWriterColor,
		},
	}
	...
	dlog.SetLayout(setting.AppSetting.TimeFormat)
}
